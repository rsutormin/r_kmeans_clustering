...
function RKmeansClustering(url, auth, auth_cb, timeout, async_job_check_time_ms) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.estimate_k = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("RKmeansClustering.estimate_k",
     ...
     this.cluster_k_means = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("RKmeansClustering.cluster_k_means",
            [params], 1, _callback, _errorCallback);
    };
